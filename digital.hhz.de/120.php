<?php
	...
	$entIdTemp = "sensor.120_temp_a"; // Temperature
	$entIdHum = "sensor.120_hum_a"; // Humidity
	$entIdMot = "sensor.120_motion_a"; // Motion
	$entIdAir = "sensor.120_co2_a"; // Air Quality
	$entIdLight = "sensor.120_light_a"; // Light
...
<html>
	<head>
		...
		<title>Digital HHZ - EG-120 sensor values</title>
