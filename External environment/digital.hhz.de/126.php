<?php
	...
	$entIdTemp = "sensor.126_2_temp_a"; // Temperature
	$entIdHum = "sensor.126_2_hum_a"; // Humidity
	$entIdMot = "sensor.126_2_motion_a"; // Motion
	$entIdAir = "sensor.126_2_co2_a"; // Air Quality
	$entIdLight = "sensor.126_2_light_a"; // Light
...
<html>
	<head>
		...
		<title>Digital HHZ - EG-126 sensor values</title>
			...
			<div class="container">
				<div class="tile" id="tileHum" onclick=flip('#tileHum')>
					...
					<div class="front humidity">
						<div class="heading">Luftqualität in %</div>
						<br>
